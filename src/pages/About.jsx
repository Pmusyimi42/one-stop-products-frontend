        ...
        <div className='about'>
         ...
         <h2 id="h21">EASE</h2>
          ...
          <div className='desc'>
            ...
            Ecommerce has already been adopted in developed countries and has proven to be one of the most successful business strategies that effectively and efficiently meet customers’ needs. Shoplite penetrating into Africa will extend the same benefits to the entire African continent despite some few existing short-term challenges such as infrastructure limitations and logistics challenges. However, some African countries, such as Kenya, have some of the best internet infrastructure in Africa. E-commerce companies, like Shoplite, have been keen to take advantage of this infrastructure by setting up in Kenya and using it as a launching pad to other African nations.
            </p>
          </div>
